            ...
            <div className="container">
                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-md-9">
                        <Form model="feedback" onSubmit={(values) => this.handleSubmmit(values)}>
                                ...
                                <Col md={10}>
                                    ...
                                    <Errors
                                        ...
                                        messages = {{
                                            ...
                                            maxLength : 'Must be less than 15 chcaracters'     
                                        }}
                                    />
                                </Col>
                            </Row>
                            ...
                            <Row className="form-group">
                                <Label htmlFor="telnum" md={2}>Contact Us</Label>
                                <Col md={10}>
                                    <Control.text model=".telnum" className="form-control" id="telnum" name="telnum" placeholder="Tel. num"
                                    validators = {{
